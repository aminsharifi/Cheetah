        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PName = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                    PDisplayName = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                    PDescription = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                    CreateTimeRecord = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    LastUpdatedRecord = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    GuidRecord = table.Column<Guid>(type: "uuid", nullable: true),
                    DsblRecord = table.Column<bool>(type: "boolean", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PERPCode = table.Column<long>(type: "bigint", nullable: true),
                    Parent_Id = table.Column<long>(type: "bigint", nullable: true),
                    PC_ShowSupport = table.Column<bool>(type: "boolean", nullable: true),
                    PC_ERP = table.Column<bool>(type: "boolean", nullable: true),
                    PC_RemoveRequestorApproval = table.Column<bool>(type: "boolean", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PERPCode = table.Column<long>(type: "bigint", nullable: true),
                    Parent_Id = table.Column<long>(type: "bigint", nullable: true),
                    ROL_Independent = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PERPCode = table.Column<long>(type: "bigint", nullable: true),
                    Parent_Id = table.Column<long>(type: "bigint", nullable: true),
                    UI_FirstName = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    UI_LastName = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    UI_NotifByEmail = table.Column<bool>(type: "boolean", nullable: true),
                    UI_NotifByMessenger = table.Column<bool>(type: "boolean", nullable: true),
                    UI_NotifByCell = table.Column<bool>(type: "boolean", nullable: true),
                    UI_ContactEmail = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    UI_ContactMessenger = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    UI_ContactCell = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    UI_UserPicture = table.Column<byte[]>(type: "bytea", nullable: true),
                    UI_NationalCode = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    UI_Birthdate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    UI_InternalPhone = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    UI_Address = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                    UI_RegistrationNumber = table.Column<string>(type: "character varying(215)", maxLength: 215, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PERPCode = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    PName = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    PDisplayName = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PERPCode = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    PName = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    PDisplayName = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    User_BossName = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                    DsblRecord = table.Column<bool>(type: "boolean", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PERPCode = table.Column<long>(type: "bigint", nullable: true),
                    Parent_Id = table.Column<long>(type: "bigint", nullable: true),
                    User_Domain = table.Column<string>(type: "character varying(25)", maxLength: 25, nullable: true),
                    User_EnabledForAssignation = table.Column<bool>(type: "boolean", nullable: true),
                    User_DelegateEnabled = table.Column<bool>(type: "boolean", nullable: true),
                    User_CreatedCasesSkipAssigRules = table.Column<bool>(type: "boolean", nullable: true),
                    User_IDPersonel = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: true),
                    User_LDAPDescription = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PERPCode = table.Column<long>(type: "bigint", nullable: true),
                    Parent_Id = table.Column<long>(type: "bigint", nullable: true),
                    ATC_Name = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    ATC_Data = table.Column<byte[]>(type: "bytea", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CD_Value = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RQT_IsTest = table.Column<bool>(type: "boolean", nullable: true),
