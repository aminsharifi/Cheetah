...
namespace Cheetah_DataAccess_SqlServer.Migrations
{
    ...
    [Migration("20230814171747_change_Condition")]
    partial class change_Condition
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cheetah_Business.Facts.F_Condition", b =>
                {
                    ...
                    b.Property<long?>("ToEndorsementId")
                        .HasColumnType("bigint")
                        .HasColumnOrder(106);
            ...
            modelBuilder.Entity("Cheetah_Business.Links.L_TagEndorsement", b =>
                {
                    b.Property<long?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("L_TagEndorsement", "Links");
                });
            ...
            modelBuilder.Entity("Cheetah_Business.Facts.F_Condition", b =>
                {
                    ...
                    b.HasOne("Cheetah_Business.Facts.F_Endorsement", "ToEndorsement")
                        .WithMany()
                        .HasForeignKey("ToEndorsementId");
            ...
            modelBuilder.Entity("Cheetah_Business.Links.L_TagEndorsement", b =>
                {
                    b.HasOne("Cheetah_Business.Dimentions.D_Tag", "D_Tag")
                        .WithMany()
                        .HasForeignKey("FirstId");

                    b.HasOne("Cheetah_Business.Facts.F_Endorsement", "F_Endorsement")
                        .WithMany("ValidUserActions")
                        .HasForeignKey("SecondId");

                    b.Navigation("D_Tag");

                    b.Navigation("F_Endorsement");
                });
